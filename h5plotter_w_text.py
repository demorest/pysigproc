...
def plot_arg(h5_file,show=False, save=True):
        plt.clf()
        ...
        with h5py.File(h5_file,'r') as f:
            ...
            gs = gridspec.GridSpec(3,2,width_ratios=[4, 1], height_ratios=[1,1,1])#,figsize=(8,6),sharex=True)
...
if __name__ == '__main__':
    with Pool(processes=35) as p:
        ...
        with tqdm(total=max_) as pbar:
            for i, _ in tqdm(enumerate(p.imap_unordered(plot_arg, args,chunksize=2))):
                pbar.update()
